...
INSERT INTO
  contact_detail (id, tel, address)
VALUES
  (1, '+123456789', '123 App Brewery Road');
...
-- Data --
INSERT INTO
  homework_submission (mark, student_id)
VALUES
  (98, 1),
  (87, 1),
  (88, 1)
...
FROM
  student
  JOIN homework_submission ON student.id = student_id
...
FROM
  ...
  -- Many to Many --
CREATE TABLE
  class (id SERIAL PRIMARY KEY, title VARCHAR(45));
